  ...
  return (
    <div className="w-11/12  mx-auto flex flex-col max-w-3xl h-screen items-center justify-center gap-4 text-center">
      ...
      <div className="flex flex-column sm:flex-row items-center gap-4 mt-4">
        <a
          href="#Contact"
          className="w-full sm:w-auto px-10 py-3 border rounded-full border-white flex items-center gap-2 bg-black text-white dark:bg-transparent dark:border-gray-500"
        >
          Contact me
        ...
        <a
          ...
          download
          className="w-full sm:w-auto px-10 py-3  border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black"
        >
          My resume
